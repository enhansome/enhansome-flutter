...
* [Flutter Catalog](https://github.com/X-Wei/flutter_catalog) ⭐ 2,288 | 🐛 21 | 🌐 Dart | 📅 2026-05-24 \[2256⭐] - showcasing Flutter components, with side-by-side source code view, by [X-Wei](https://github.com/X-Wei).
...
* [Flyer Chat](https://github.com/flyerhq/flutter_chat_ui) ⭐ 2,333 | 🐛 28 | 🌐 Dart | 📅 2026-04-18 \[2070⭐] - Community-driven chat UI implementation by the [Flyer Chat team](https://github.com/flyerhq).
...
* [Forui](https://github.com/forus-labs/forui) ⭐ 2,319 | 🐛 44 | 🌐 Dart | 📅 2026-08-29 \[1379⭐] - Minimalistic UI library heavily inspired by shadcn/ui by [Forus Labs](https://github.com/forus-labs).
* [TDesign Flutter](https://github.com/Tencent/tdesign-flutter) ⭐ 1,191 | 🐛 83 | 🌐 Dart | 📅 2026-08-29 \[951⭐] - A useful UI component library matches the TDesign style by [Tencent](https://github.com/Tencent).
...
* [Image Picker](https://github.com/flutter/packages/tree/main/packages/image_picker) ⭐ 5,299 | 🐛 206 | 🌐 Dart | 📅 2026-08-28 - Images Selection by [Collin Jackson](http://www.collinjackson.com).
...
* [FL Chart](https://github.com/imaNNeoFighT/fl_chart) ⭐ 7,576 | 🐛 406 | 🌐 Dart | 📅 2026-07-24 \[7313⭐] - Draw fantastic charts in Flutter by [Iman Khoshabi](http://www.ikhoshabi.com).
...
* [Firebase Auth](https://github.com/FirebaseExtended/flutterfire/tree/master/packages/firebase_auth) ⭐ 9,251 | 🐛 66 | 🌐 Dart | 📅 2026-08-28 - Firebase OAuth.
* [Local Auth](https://github.com/flutter/packages/tree/main/packages/local_auth) ⭐ 5,299 | 🐛 206 | 🌐 Dart | 📅 2026-08-28 - Touch ID, lock code, fingerprint auth on iOS and Android.
* [Google Sign-In](https://github.com/flutter/packages/tree/main/packages/google_sign_in) ⭐ 5,299 | 🐛 206 | 🌐 Dart | 📅 2026-08-28 - Google OAuth.
...
* [Firebase Analytics](https://github.com/FirebaseExtended/flutterfire/tree/master/packages/firebase_analytics) ⭐ 9,251 | 🐛 66 | 🌐 Dart | 📅 2026-08-28 - Connect to Firebase Analytics API.
...
* [WebRTC](https://github.com/cloudwebrtc/flutter-webrtc) ⭐ 4,484 | 🐛 695 | 🌐 C++ | 📅 2026-08-24 \[4386⭐] - WebRTC plugin for iOS/Android by [CloudWebRtc](https://github.com/cloudwebrtc).
...
* [Firebase Storage](https://github.com/FirebaseExtended/flutterfire/tree/master/packages/firebase_storage) ⭐ 9,251 | 🐛 66 | 🌐 Dart | 📅 2026-08-28 - Firebase as data storage.
...
* [Firebase AdMob](https://github.com/FirebaseExtended/flutterfire/tree/master/packages/firebase_admob) ⭐ 9,251 | 🐛 66 | 🌐 Dart | 📅 2026-08-28 - Ad integration using Firebase.
...
* [Flutter Samples](https://github.com/diegoveloper/flutter-samples) ⭐ 3,208 | 🐛 3 | 🌐 Dart | 📅 2025-11-02 \[3191⭐] - Collection of nice flutter samples by [Diego Velásquez](https://github.com/diegoveloper).
...
* [RustDesk](https://github.com/rustdesk/rustdesk) ⭐ 122,109 | 🐛 145 | 🌐 Rust | 📅 2026-08-28 \[99332⭐] - Open source virtual / remote desktop. TeamViewer alternative.  Built with Rust by [RustDesk team](https://www.rustdesk.com/).
...
* [Plugins](https://github.com/flutter/packages/tree/main/packages) ⭐ 5,299 | 🐛 206 | 🌐 Dart | 📅 2026-08-28 - Official Flutter Team Plugins.
...
* [File Picker](https://github.com/miguelpruivo/plugins_flutter_file_picker) ⭐ 1,560 | 🐛 13 | 🌐 Dart | 📅 2026-08-28 \[1494⭐] - Native file explorer to load absolute file path by [Miguel Ruivo](https://github.com/miguelpruivo).
...
* [Drift](https://github.com/simolus3/drift) ⭐ 3,266 | 🐛 211 | 🌐 Dart | 📅 2026-08-26 - Drift is an easy to use, reactive, typesafe persistence library for Dart & Flutter by [.
...
* [GetX](https://github.com/jonataslaw/getx) ⭐ 11,200 | 🐛 1,177 | 🌐 Dart | 📅 2026-06-12 \[11002⭐] - Contextless, State-management & navigation by [Jonny Borges](https://github.com/jonataslaw).
...
* [Patrol](https://github.com/leancodepl/patrol) ⭐ 1,417 | 🐛 200 | 🌐 Dart | 📅 2026-08-29 \[1131⭐] - Easy-to-learn, powerful UI testing framework eliminating limitations of `flutter_test`, `integration_test`, and `flutter_driver` by [LeanCode](https://leancode.co).
...
* [Flame](https://github.com/flame-engine/flame) ⭐ 10,735 | 🐛 92 | 🌐 Dart | 📅 2026-08-28 \[10193⭐] - Minimalist game engine by [Luan Nico](https://github.com/luanpotter).
...
* [RustDesk](https://github.com/rustdesk/rustdesk) ⭐ 122,109 | 🐛 145 | 🌐 Rust | 📅 2026-08-28 \[99332⭐] - Open source virtual/remote desktop and TeamViewer alternative. Built with Flutter and Rust by [RustDesk team](https://www.rustdesk.com/).
* [AppFlowy](https://github.com/AppFlowy-IO/appflowy) ⭐ 76,060 | 🐛 1,009 | 🌐 Dart | 📅 2026-08-28 \[65821⭐] - Open Source Notion Alternative. You are in charge of your data and customizations. Built with Flutter and Rust by [AppFlowy team](https://www.appflowy.io/).
* [Spotube](https://github.com/KRTirtho/spotube) ⭐ 48,787 | 🐛 849 | 🌐 Dart | 📅 2026-08-28 - Open source Spotify client for desktop and mobile by [Kingkor Roy Tirtho](https://github.com/KRTirtho).
...
* [Spotube](https://github.com/KRTirtho/spotube) ⭐ 48,787 | 🐛 849 | 🌐 Dart | 📅 2026-08-28 \[41650⭐] - A lightweight free Spotify crossplatform-client with no Spotify premium account requirement by [KRTirtho](https://github.com/KRTirtho).
* [Flutter Common Widgets](https://github.com/alibaba/flutter-common-widgets-app) ⭐ 23,646 | 🐛 193 | 🌐 Dart | 📅 2023-12-11 \[23710⭐] - Collection of official widgets demos & docs in chinese to help developers learn quickly by [Alibaba Auction Frontend Team](https://github.com/alibaba-paimai-frontend).
* [Flutter Team Samples](https://github.com/flutter/samples) ⭐ 19,250 | 🐛 18 | 🌐 Dart | 📅 2026-08-27 \[18613⭐] - Collection of examples (including maps, json, Material and Cupertino) by the [Flutter team](https://github.com/orgs/flutter/people).
...
* [GitJournal](https://github.com/GitJournal/GitJournal) ⭐ 4,212 | 🐛 132 | 🌐 Dart | 📅 2026-05-26 \[3893⭐] - Journaling your data in a Git Repo by [Vishesh Handa](https://github.com/vHanda).
...
* [BloomeeTunes](https://github.com/HemantKArya/BloomeeTunes) ⭐ 2,206 | 🐛 193 | 🌐 Dart | 📅 2026-07-30 \[1304⭐] - Multi-Source Music Streaming Application by [HemantKArya](https://github.com/HemantKArya).
...
* [Linwood Butterfly](https://github.com/LinwoodCloud/Butterfly) ⭐ 1,987 | 🐛 43 | 🌐 Dart | 📅 2026-08-29 \[1463⭐] - Powerful note taking app and an alternative to OneNote by [CodeDoctorDE](https://github.com/CodeDoctorDE).
...
* [Openreads](https://github.com/mateusz-bak/openreads-android) ⭐ 1,626 | 🐛 47 | 🌐 Dart | 📅 2026-07-20 \[1303⭐] - A simple privacy oriented mobile books tracker using Open Library API by [mateusz-bak](https://github.com/mateusz-bak).
...
* [Golang Desktop Embedder](https://github.com/go-flutter-desktop/go-flutter) ⭐ 5,931 | 🐛 65 | 🌐 Go | 📅 2026-08-29 \[5929⭐] - Golang embedder for desktop by [Pierre Champion](https://github.com/pchampio).
* [Fluent UI](https://github.com/bdlukaa/fluent_ui) ⭐ 3,463 | 🐛 44 | 🌐 Dart | 📅 2026-08-29 \[3305⭐] - Microsoft's Fluent Design System in Flutter by [Bruno D'Luka](https://twitter.com/bdlukaadev).
