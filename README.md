...
* [Forui](https://github.com/forus-labs/forui) ⭐ 2,318 | 🐛 44 | 🌐 Dart | 📅 2026-08-28 \[1379⭐] - Minimalistic UI library heavily inspired by shadcn/ui by [Forus Labs](https://github.com/forus-labs).
* [TDesign Flutter](https://github.com/Tencent/tdesign-flutter) ⭐ 1,191 | 🐛 83 | 🌐 Dart | 📅 2026-08-28 \[951⭐] - A useful UI component library matches the TDesign style by [Tencent](https://github.com/Tencent).
...
* [Cached Network Image](https://github.com/renefloor/flutter_cached_network_image) ⭐ 2,585 | 🐛 331 | 🌐 Dart | 📅 2026-08-28 \[2547⭐] - Show images from the internet and keep them in the cache directory by.
...
* [Image Picker](https://github.com/flutter/packages/tree/main/packages/image_picker) ⭐ 5,299 | 🐛 205 | 🌐 Dart | 📅 2026-08-28 - Images Selection by [Collin Jackson](http://www.collinjackson.com).
...
* [Firebase Auth](https://github.com/FirebaseExtended/flutterfire/tree/master/packages/firebase_auth) ⭐ 9,251 | 🐛 65 | 🌐 Dart | 📅 2026-08-28 - Firebase OAuth.
* [Local Auth](https://github.com/flutter/packages/tree/main/packages/local_auth) ⭐ 5,299 | 🐛 205 | 🌐 Dart | 📅 2026-08-28 - Touch ID, lock code, fingerprint auth on iOS and Android.
* [Google Sign-In](https://github.com/flutter/packages/tree/main/packages/google_sign_in) ⭐ 5,299 | 🐛 205 | 🌐 Dart | 📅 2026-08-28 - Google OAuth.
...
* [Firebase Analytics](https://github.com/FirebaseExtended/flutterfire/tree/master/packages/firebase_analytics) ⭐ 9,251 | 🐛 65 | 🌐 Dart | 📅 2026-08-28 - Connect to Firebase Analytics API.
...
* [Firebase Storage](https://github.com/FirebaseExtended/flutterfire/tree/master/packages/firebase_storage) ⭐ 9,251 | 🐛 65 | 🌐 Dart | 📅 2026-08-28 - Firebase as data storage.
...
* [Firebase AdMob](https://github.com/FirebaseExtended/flutterfire/tree/master/packages/firebase_admob) ⭐ 9,251 | 🐛 65 | 🌐 Dart | 📅 2026-08-28 - Ad integration using Firebase.
...
* [Plugins](https://github.com/flutter/packages/tree/main/packages) ⭐ 5,299 | 🐛 205 | 🌐 Dart | 📅 2026-08-28 - Official Flutter Team Plugins.
...
* [File Picker](https://github.com/miguelpruivo/plugins_flutter_file_picker) ⭐ 1,560 | 🐛 11 | 🌐 Dart | 📅 2026-08-28 \[1494⭐] - Native file explorer to load absolute file path by [Miguel Ruivo](https://github.com/miguelpruivo).
...
* [RiverPod](https://github.com/rrousselGit/river_pod) ⭐ 7,373 | 🐛 163 | 🌐 Dart | 📅 2026-08-24 \[6922⭐] - Provider, but different by [Remi Rousselet](https://github.com/rrousselGit).
...
* [Patrol](https://github.com/leancodepl/patrol) ⭐ 1,417 | 🐛 199 | 🌐 Dart | 📅 2026-08-27 \[1131⭐] - Easy-to-learn, powerful UI testing framework eliminating limitations of `flutter_test`, `integration_test`, and `flutter_driver` by [LeanCode](https://leancode.co).
...
* [Flame](https://github.com/flame-engine/flame) ⭐ 10,733 | 🐛 92 | 🌐 Dart | 📅 2026-08-28 \[10193⭐] - Minimalist game engine by [Luan Nico](https://github.com/luanpotter).
...
* [AuthPass](https://github.com/authpass/authpass) ⭐ 2,767 | 🐛 165 | 🌐 Dart | 📅 2026-08-28 \[2471⭐] - Keepass compatible password manager for mobile and desktop by [hpoul](https://github.com/hpoul).
...
* [Linwood Butterfly](https://github.com/LinwoodCloud/Butterfly) ⭐ 1,986 | 🐛 45 | 🌐 Dart | 📅 2026-08-27 \[1463⭐] - Powerful note taking app and an alternative to OneNote by [CodeDoctorDE](https://github.com/CodeDoctorDE).
...
* [FVM](https://github.com/leoafarias/fvm) ⭐ 5,506 | 🐛 56 | 🌐 Dart | 📅 2026-08-27 \[5191⭐] - Flutter Version Management: A simple cli to manage Flutter SDK versions.
...
* [Fluent UI](https://github.com/bdlukaa/fluent_ui) ⭐ 3,463 | 🐛 45 | 🌐 Dart | 📅 2026-08-28 \[3305⭐] - Microsoft's Fluent Design System in Flutter by [Bruno D'Luka](https://twitter.com/bdlukaadev).
